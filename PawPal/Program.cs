...
builder.Services.AddDbContextFactory<PawPalContext>(options =>
    options.UseSqlServer(builder.Configuration.GetConnectionString("PawPalContext") ?? throw new InvalidOperationException("Connection string 'PawPalContext' not found.")));
